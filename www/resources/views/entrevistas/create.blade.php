                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        @error('entrevista_numero')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                        @enderror
                                        <small class="text-muted">Siguiente sugerido: {{ $siguiente_numero }}</small>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="anotaciones" id="anotaciones" class="form-control" rows="3"
                                    placeholder="Observaciones adicionales sobre la entrevista">{{ old('anotaciones') }}</textarea>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            ...
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="es_virtual_si" name="es_virtual" value="1" class="custom-control-input" {{ old('es_virtual') == 1 ? 'checked' : '' }}>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="nna_no" name="nna" value="0" class="custom-control-input" {{ old('nna', 0) == 0 ? 'checked' : '' }}>
                                                <label class="custom-control-label" for="nna_no">No</label>
                                            </div>
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="nna_si" name="nna" value="1" class="custom-control-input" {{ old('nna') == 1 ? 'checked' : '' }}>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            ...
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="radio" id="id_etnico_si" name="id_etnico" value="1" class="custom-control-input" {{ old('id_etnico') == 1 ? 'checked' : '' }}>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <select name="id_territorio" id="id_territorio" class="form-control">
                                    ...
                                    <option value="{{ $id }}" {{ old('id_territorio') == $id ? 'selected' : '' }}>{{ $nombre }}</option>
                                    @endforeach
                                </select>
                            </div>
