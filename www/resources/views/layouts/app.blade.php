                ...
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview">
                    ...
                    <li class="nav-item has-treeview {{ request()->routeIs('procesamientos.*') ? 'menu-open' : '' }}">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="{{ route('procesamientos.anonimizacion') }}" class="nav-link {{ request()->routeIs('procesamientos.anonimizacion') || request()->routeIs('procesamientos.previsualizar-anonimizacion') ? 'active' : '' }}">
    ...
    <div class="content-wrapper">
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>@yield('content_header', 'Dashboard')</h1>
                    </div>
                </div>
            </div>
        </section>
