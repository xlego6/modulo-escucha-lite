            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-4 col-6 mb-2">
                        <span class="badge badge-{{ $tipo == 'PER' ? 'primary' : ($tipo == 'LOC' ? 'success' : ($tipo == 'ORG' ? 'info' : ($tipo == 'DATE' ? 'secondary' : ($tipo == 'EVENT' ? 'warning' : ($tipo == 'GUN' ? 'danger' : 'dark'))))) }} p-2">
                            {{ $tipo }}
                        </span>
