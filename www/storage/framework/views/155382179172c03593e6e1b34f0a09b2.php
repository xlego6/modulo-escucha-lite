        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="nombre_proyecto" name="nombre_proyecto" maxlength="500" value="<?php echo e($entrevista->nombre_proyecto); ?>">
...
$(document).ready(function() {
    ...
    <?php if($entrevista->id_dependencia_origen): ?>
    var equiposData = <?php echo json_encode($catalogos['equipos_estrategias']); ?>;
    var depId = '<?php echo e($entrevista->id_dependencia_origen); ?>';
    ...
    <?php if($entrevista->id_equipo_estrategia): ?>
    equipoSelect.val('<?php echo e($entrevista->id_equipo_estrategia); ?>');
    <?php endif; ?>
    <?php endif; ?>
});
</script>
